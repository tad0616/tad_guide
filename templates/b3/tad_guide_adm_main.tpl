            ...
            <tbody>
                <{foreach from=$all_data key=mod_dirname item=mod}>
                    ...
                    <td nowrap>
                        ...
                        <{elseif  $mod.function=='latest' or $mod.function=='upgrade'}>
                    ...
                    <td style="text-align:center;">
                        ...
                        <{if $act_log.$mod_dirname.config}>
                            ...
                            <a href="main.php?op=import_data&dirname=<{$mod_dirname}>&act_kind=restore_config&mid=<{$mod.mid}>" class="btn btn-info" alt="<{$smarty.const._MA_GUIDE_RESTORE_CONFIG}>" title="<{$smarty.const._MA_GUIDE_RESTORE_CONFIG}>"><i class="fa fa-repeat"></i></a>
                        <{else}>
                            <a href="main.php?op=import_data&dirname=<{$mod_dirname}>&act_kind=config&mid=<{$mod.mid}>" class="btn btn-info" alt="<{$smarty.const._MA_GUIDE_IMPORT_CONFIG}>" title="<{$smarty.const._MA_GUIDE_IMPORT_CONFIG}>"><i class="fa fa-cog"></i></a>
                        <{/if}>
                    ...
                    <td style="text-align:center;">
                        ...
                        <{if $act_log.$mod_dirname.content_all}>
                            ...
                            <a href="main.php?op=import_data&dirname=<{$mod_dirname}>&act_kind=restore&mid=<{$mod.mid}>" class="btn btn-info" alt="<{$smarty.const._MA_GUIDE_RESTORE_CONTENT}>" title="<{$smarty.const._MA_GUIDE_RESTORE_CONTENT}>"><i class="fa fa-repeat"></i></a>
                        <{else}>
                            <a href="main.php?op=import_data&dirname=<{$mod_dirname}>&act_kind=content_all&mid=<{$mod.mid}>" class="btn btn-info" alt="<{$smarty.const._MA_GUIDE_IMPORT_CONTENT}>" title="<{$smarty.const._MA_GUIDE_IMPORT_CONTENT}>"><i class="fa fa-cloud-download"></i></a>
                        <{/if}>
                    ...
                    <td style="text-align:center;">
                        ...
                        <{if $act_log.$mod_dirname.blocks}>
                            ...
                            <a href="main.php?op=import_data&dirname=<{$mod_dirname}>&act_kind=restore_blocks&mid=<{$mod.mid}>" class="btn btn-info" alt="<{$smarty.const._MA_GUIDE_RESTORE_BLOCKS}>" title="<{$smarty.const._MA_GUIDE_RESTORE_BLOCKS}>"><i class="fa fa-repeat"></i></a>
                        <{else}>
                            <a href="main.php?op=import_data&dirname=<{$mod_dirname}>&act_kind=blocks" class="btn btn-info" alt="<{$smarty.const._MA_GUIDE_IMPORT_BLOCKS}>" title="<{$smarty.const._MA_GUIDE_IMPORT_BLOCKS}>"><i class="fa fa-arrow-down"></i></a>
                        <{/if}>
                    ...
                    <{foreach from=$log.$mod_dirname.cates item=cates key=groupid}>
                        ...
                        <{if $cates.cate_title}>
                            ...
                            <{if $log.$mod_dirname.content_exists and $mod.function!='install'}>
                                ...
                                <{else}>
                                <a href="main.php?op=import_data&dirname=<{$mod_dirname}>&act_kind=content&mid=<{$mod.mid}>&cate_sn=<{$cates.cate_sn}>" class="btn btn-info" alt="<{$smarty.const._MA_GUIDE_IMPORT_CONTENT}>" title="<{$smarty.const._MA_GUIDE_IMPORT_CONTENT}>"><i class="fa fa-cloud-download"></i></a>
                                <{/if}>
                        ...
                        <{elseif $cates.mid and $cates.show_cate}>
                            <td style="text-align:center;;background-color:#F1F2F0;">
                            <a href="main.php?op=create_one_cate&mid=<{$mod.mid}>&groupid=<{$groupid}>&dirname=<{$mod_dirname}>" alt="<{$cates.groupname|string_format:$smarty.const._MA_GUIDE_CREATE_CATE}>" title="<{$cates.groupname|string_format:$smarty.const._MA_GUIDE_CREATE_CATE}>" class="btn btn-info"><i class="fa fa-folder-open"></i></a>
                            </td>
                        <{else}>
                            <td style="text-align:center;background-color:#F1F2F0;">
