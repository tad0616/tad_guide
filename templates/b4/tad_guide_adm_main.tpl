  ...
  <{else}>
    ...
    <form action="main.php" method="post" role="form">
      <div class="form-group row">
        ...
        <div class="col-sm-1">
          <button type="submit" class="btn btn-sm btn-primary"><{$smarty.const._MA_GUIDE_CREATE}></button>
        </div>
      </div>
    </form>
            ...
            <tr <{if $mod_dirname==$hl and $hl!=""}>style="background-color:yellow;"<{/if}>>
              ...
              <td nowrap>
                <a name="<{$mod_dirname}>"> </a>
                  <a id="view_card card-body bg-light m-1<{$mod.module_sn}>" class="btn btn-sm  btn-info" href="javascript:alert('<{$mod.update_descript}>')"><{$mod.module_sn}></a>
              ...
              <td nowrap>
                <{if $mod.function=='update'}>
                  <a href="<{$xoops_url}>/modules/<{$mod_dirname}>" class="btn btn-sm  btn-info" target="_blank" alt="<{$smarty.const._MA_GUIDE_TO_MODULE}>" title="<{$smarty.const._MA_GUIDE_TO_MODULE}>"><i class="fa fa-arrow-right"></i></a>
                  <a href="main.php?op=update_module&dirname=<{$mod_dirname}>&file_link=<{$mod.file_link}>&update_sn=<{$mod.update_sn}>&tad_adm_tpl=clean" class="btn btn-sm  btn-danger modulesadmin"  data-fancybox-type="iframe"><{$smarty.const._MA_GUIDE_MOD_UPDATE_MODULE}> <{$mod.new_version}></a>
                ...
                <{elseif $mod.function=='install'}>
                  <a href="main.php?op=install_module&dirname=<{$mod_dirname}>&file_link=<{$mod.file_link}>&update_sn=<{$mod.update_sn}>&tad_adm_tpl=clean" class="btn btn-sm btn-success  btn-block modulesadmin" data-fancybox-type="iframe">
              ...
              <td style="text-align:center;">
                <{if $log.$mod_dirname.config_exists and $mod.function!='install'}>
                  <{if $act_log.$mod_dirname.config}>
                    ...
                    <a href="main.php?op=import_data&dirname=<{$mod_dirname}>&act_kind=restore_config&mid=<{$mod.mid}>" class="btn btn-sm btn-secondary " alt="<{$smarty.const._MA_GUIDE_RESTORE_CONFIG}>" title="<{$smarty.const._MA_GUIDE_RESTORE_CONFIG}>"><i class="fa fa-repeat"></i></a>
                  <{else}>
                    <a href="main.php?op=import_data&dirname=<{$mod_dirname}>&act_kind=config&mid=<{$mod.mid}>" class="btn btn-sm btn-secondary " alt="<{$smarty.const._MA_GUIDE_IMPORT_CONFIG}>" title="<{$smarty.const._MA_GUIDE_IMPORT_CONFIG}>"><i class="fa fa-cog"></i></a>
                  <{/if}>
              ...
              <td style="text-align:center;">
                <{if $log.$mod_dirname.content_all_exists and $mod.function!='install'}>
                  <{if $act_log.$mod_dirname.content_all}>
                    ...
                    <a href="main.php?op=import_data&dirname=<{$mod_dirname}>&act_kind=restore&mid=<{$mod.mid}>" class="btn btn-sm btn-secondary " alt="<{$smarty.const._MA_GUIDE_RESTORE_CONTENT}>" title="<{$smarty.const._MA_GUIDE_RESTORE_CONTENT}>"><i class="fa fa-repeat"></i></a>
                  <{else}>
                    <a href="main.php?op=import_data&dirname=<{$mod_dirname}>&act_kind=content_all&mid=<{$mod.mid}>" class="btn btn-sm btn-secondary " alt="<{$smarty.const._MA_GUIDE_IMPORT_CONTENT}>" title="<{$smarty.const._MA_GUIDE_IMPORT_CONTENT}>"><i class="fa fa-cloud-download"></i></a>
                  <{/if}>
              ...
              <td style="text-align:center;">
                <{if $log.$mod_dirname.blocks_file_exists and $mod.function!='install'}>
                  <{if $act_log.$mod_dirname.blocks}>
                    ...
                    <a href="main.php?op=import_data&dirname=<{$mod_dirname}>&act_kind=restore_blocks&mid=<{$mod.mid}>" class="btn btn-sm btn-secondary " alt="<{$smarty.const._MA_GUIDE_RESTORE_BLOCKS}>" title="<{$smarty.const._MA_GUIDE_RESTORE_BLOCKS}>"><i class="fa fa-repeat"></i></a>
                  <{else}>
                    <a href="main.php?op=import_data&dirname=<{$mod_dirname}>&act_kind=blocks" class="btn btn-sm btn-secondary " alt="<{$smarty.const._MA_GUIDE_IMPORT_BLOCKS}>" title="<{$smarty.const._MA_GUIDE_IMPORT_BLOCKS}>"><i class="fa fa-arrow-down"></i></a>
                  <{/if}>
              ...
              <{foreach from=$log.$mod_dirname.cates item=cates key=groupid}>
                ...
                <{if $groupid > 3}>
                  <{if $cates.cate_title}>
                    <td style="text-align:center;background-color:#F1F2F0;">
                      ...
                      <{if $log.$mod_dirname.content_exists and $mod.function!='install'}>
                        ...
                        <{else}>
                          <a href="main.php?op=import_data&dirname=<{$mod_dirname}>&act_kind=content&mid=<{$mod.mid}>&cate_sn=<{$cates.cate_sn}>" class="btn btn-sm btn-secondary " alt="<{$smarty.const._MA_GUIDE_IMPORT_CONTENT}>" title="<{$smarty.const._MA_GUIDE_IMPORT_CONTENT}>"><i class="fa fa-cloud-download"></i></a>
                        <{/if}>
                  ...
                  <{elseif $cates.mid and $cates.show_cate}>
                    <td style="text-align:center;;background-color:#F1F2F0;">
                      <a href="main.php?op=create_one_cate&mid=<{$mod.mid}>&groupid=<{$groupid}>&dirname=<{$mod_dirname}>" alt="<{$cates.groupname|string_format:$smarty.const._MA_GUIDE_CREATE_CATE}>" title="<{$cates.groupname|string_format:$smarty.const._MA_GUIDE_CREATE_CATE}>" class="btn btn-sm btn-secondary "><i class="fa fa-folder-open"></i></a>
                    </td>
                  <{else}>
                    <td style="text-align:center;background-color:#F1F2F0;">
