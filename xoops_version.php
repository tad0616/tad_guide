...
//---樣板設定---//
$i                                          = 0;
$modversion['templates'][$i]['file']        = 'tad_guide_adm_main.html';
$modversion['templates'][$i]['description'] = 'tad_guide_adm_main.html';

$i++;
$modversion['templates'][$i]['file']        = 'tad_guide_adm_main_b3.html';
$modversion['templates'][$i]['description'] = 'tad_guide_adm_main_b3.html';
