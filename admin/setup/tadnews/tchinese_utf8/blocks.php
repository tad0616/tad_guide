...
//電子報一覽
$new_data[5] = ['options' => '10', 'title' => '電子報一覽', 'side' => '1', 'weight' => '9', 'visible' => '0'];
//分類新聞區塊
$new_data[6] = ['options' => '|5|1|1|99|color: gray; font-size: 0.75em; margin: 6px 0px; line-height: 180%;', 'title' => '分類新聞區塊', 'side' => '9', 'weight' => '15', 'visible' => '0'];
//自訂頁面樹狀目錄
$new_data[7] = ['options' => '0|160|0.9rem', 'title' => '學校介紹選單', 'side' => '0', 'weight' => '12', 'visible' => '0'];
//焦點新聞
$new_data[8] = ['options' => '|full', 'title' => '焦點新聞', 'side' => '9', 'weight' => '16', 'visible' => '0'];
//自選文章
$new_data[9] = ['options' => '', 'title' => '自選文章', 'side' => '9', 'weight' => '0', 'visible' => '0'];
//條列式新聞
$new_data[10] = ['options' => '5|0|color:gray;font-size: 0.75em;margin-top:6px;line-height:180%;|0|1|width:60px;height:30px;float:left;border:0px solid #9999CC;margin:0px 4px 4px 0px;overflow:hidden;background-size:cover;|0|list|list|0|0', 'title' => '條列式新聞[pic]images/newstitle.png', 'side' => '9', 'weight' => '5', 'visible' => '0'];
//表格式新聞
$new_data[11] = ['options' => '6|1|start_day|news_title|uid|ncsn|counter|0||0', 'title' => '表格式新聞[pic]images/newstitle.png', 'side' => '9', 'weight' => '13', 'visible' => '0'];
//滑動新聞
$new_data[12] = ['options' => '670|250|5|90|', 'title' => '滑動新聞[hide]', 'side' => '9', 'weight' => '11', 'visible' => '0'];
//自動縮放的滑動新聞
$new_data[13] = ['options' => '5|90|ResponsiveSlides|7', 'title' => '自動縮放的滑動新聞[hide]', 'side' => '9', 'weight' => '4', 'visible' => '0'];
//跑馬燈區塊
