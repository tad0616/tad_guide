...
function tad_link_content($cate_sn = '')
{
    ...
    VALUES
    (0,?, ?)';
    Utility::query($sql, 'si', ['宣導網站', $max_sort]) or Utility::web_error($sql, __FILE__, __LINE__);
    ...
    VALUES
    (0, ?, ?)';
    $result = Utility::query($sql, 'si', ['常用網站', $max_sort]) or Utility::web_error($sql, __FILE__, __LINE__);
    ...
    VALUES
    (0, ?, ?)';
    Utility::query($sql, 'si', ['教育網站', $max_sort]) or Utility::web_error($sql, __FILE__, __LINE__);
